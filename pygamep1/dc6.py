...
for y in range(3):
    for x in range(3):
        ...
        def on_click(b=b):
                ...
                monster_health('left mouse down',b=b)
                mover()              
                game_over()
                destroy(player_bar)
...
def monster_mover():
        ...
        choose = random.randrange(0, 20)
        if choose > 2:
                if board[1][1].name == "player" and player.position == (1,2,0) :    
                        board[1][1].name = "monster"           
                        destroy(text5)
                        destroy(text6)     
                        ...
                        board[1][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])               
                if board[1][1].name == "player" and player.position == (1,0,0) :
                ...
                if board[1][1].name == "player" and player.position == (0,1,0) :
                ...
                if board[1][1].name == "player" and player.position == (2,1,0) :
                ...
                if board[0][1].name == "player" and player.position == (0,2,0) :
                        board[0][1].texture = board[0][0].texture
                        board[0][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][1].name = "monster"
                        destroy(text3)
                        destroy(text2)
                        mon_health2 = health_bar(board[0][1],str(health2),255,255,255,-1.5,-2)
                ...
                if board[0][1].name == "player" and player.position == (0,0,0) :
                ...
                if board[1][2].name == "player" and player.position == (0,2,0) :
                        board[1][2].texture = board[2][2].texture
                        board[2][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[1][2].name = "monster"
                        destroy(text6)
                        destroy(text3)
                        mon_health6 = health_bar(board[1][2],str(health6),255,255,255,-1.5,-2)
                        ...
                        text9 = health_bar(board[2][2],str(damage8),255,255,255,1.5,-2)
                        health = health - damage3 
                if board[1][2].name == "player" and player.position == (2,2,0) :
                ...
                if board[2][1].name == "player" and player.position == (2,2,0) :
                        board[2][1].texture = board[2][0].texture
                        board[2][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][1].name = "monster"
                        destroy(text9)
                        destroy(text8)
                        mon_health8 = health_bar(board[2][1],str(health8),255,255,255,-1.5,-2)
                        ...
                        text7 = health_bar(board[2][0],str(damage6),255,255,255,1.5,-2) 
                        health = health - damage8  
                if board[2][1].name == "player" and player.position == (2,0,0) :
                ...
                if board[1][0].name == "player" and player.position == (0,0,0) :
                        board[1][0].texture = board[2][0].texture
                        board[2][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[1][0].name = "monster"
                        destroy(text1)
                        destroy(text4)
                        mon_health4 = health_bar(board[1][0],str(health4),255,255,255,-1.5,-2)
                        ...
                        text7 = health_bar(board[2][0],str(damage6),255,255,255,1.5,-2)
                        health = health - damage1   
                if board[1][0].name == "player" and player.position == (2,0,0) :
                        ...
                        text1 = health_bar(board[0][0],str(damage1),255,255,255,1.5,-2)
                        health = health - damage6   
                if board[0][2].name == "player" and player.position == (1,2,0) :
                        board[0][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][2].name = "monster"
                        destroy(text6)
                        destroy(text3)
                        mon_health3 = health_bar(board[0][2],str(health3),255,255,255,-1.5,-2)
                        damage3 =random.randrange(4, 20)
                        text3 = health_bar(board[0][2],str(damage3),255,255,255,1.5,-2)   
                        health = health - damage5
                if board[0][2].name == "player" and player.position == (0,1,0) :
                        board[0][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][2].name = "monster"
                        destroy(text2)
                        destroy(text3)
                        ...
                        text3 = health_bar(board[0][2],str(damage3),255,255,255,1.5,-2)
                        health = health - damage2  
                if board[2][2].name == "player" and player.position == (1,2,0) :
                        board[2][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][2].name = "monster"
                        destroy(text6)
                        destroy(text9)
                        mon_health9 = health_bar(board[2][2],str(health9),255,255,255,-1.5,-2)
                        damage8 =random.randrange(4, 20)
                        text9 = health_bar(board[2][2],str(damage8),255,255,255,1.5,-2)
                        health = health - damage6  
                if board[2][2].name == "player" and player.position == (2,1,0) :
                        board[2][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][2].name = "monster"
                        destroy(text8)
                        destroy(text9)
                        ...
                        text9 = health_bar(board[2][2],str(damage8),255,255,255,1.5,-2)
                        health = health - damage7   
                if board[2][0].name == "player" and player.position == (2,1,0) :
                        board[2][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][0].name = "monster"
                        destroy(text7)
                        destroy(text8)
                        mon_health7 = health_bar(board[2][0],str(health7),255,255,255,-1.5,-2)
                        damage6 =random.randrange(4, 20)
                        text7 = health_bar(board[2][0],str(damage6),255,255,255,1.5,-2)
                        health = health - damage7    
                if board[2][0].name == "player" and player.position == (1,0,0) :
                        board[2][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][0].name = "monster"
                        destroy(text7)
                        destroy(text4)
                        ...
                        text7 = health_bar(board[2][0],str(damage6),255,255,255,1.5,-2)
                        health = health - damage4 
                if board[0][0].name == "player" and player.position == (0,1,0) :
                        board[0][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][0].name = "monster"
                        destroy(text1)
                        destroy(text2)
                        mon_health1 = health_bar(board[0][0],str(health1),255,255,255,-1.5,-2)
                        damage1 =random.randrange(4, 20)
                        text1 = health_bar(board[0][0],str(damage1),255,255,255,1.5,-2)
                        health = health - damage2   
                if board[0][0].name == "player" and player.position == (1,0,0) :
                        board[0][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][0].name = "monster"
                        destroy(text1)
                        destroy(text4)
                        ...
                        text1= health_bar(board[0][0],str(damage1),255,255,255,1.5,-2)
                        health = health - damage4     
                if board[2][1].name == "player" and player.position == (1,1,0) :
                        board[2][1].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[2][1].name = "monster"
                        destroy(text5)
                        destroy(text8)
                ...
                if board[1][2].name == "player" and player.position == (1,1,0) :
                        board[1][2].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[1][2].name = "monster"
                        destroy(text6)
                        destroy(text5)
                        ...
                        text6 = health_bar(board[1][2],str(damage5),255,255,255,1.5,-2)
                        health = health - damage9    
                if board[1][0].name == "player" and player.position == (1,1,0) :
                        board[1][0].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[1][0].name = "monster"
                        destroy(text4)
                        destroy(text5)
                        ...
                        text4 = health_bar(board[1][0],str(damage4),255,255,255,1.5,-2)
                        health = health - damage9   
                if board[0][1].name == "player" and player.position == (1,1,0) :
                        board[0][1].texture = random.choice(["m1.png","m2.png","m3.png","m4.png","m5.png"])
                        board[0][1].name = "monster"
                        destroy(text2)
                        destroy(text5)
            ...
            if key == 'left mouse down': 
                    if board[0][0].name == "monster":
                                ...
                                if health1 < 1:
                                                ...
                                                health -= damage1  
                    elif board[0][0].name == "chest":
                            chest(self)
                            

        if board[0][1].hovered:
            if key == 'left mouse down':
                    if board[0][1].name == "monster":
                                destroy(mon_health2)
                                health2 -= player_dmg    
                                mon_health2 = health_bar(board[0][1],str(health2),255,255,255,-1.5,-2) 
                                if health2 < 1:
        ...
        if board[2][2].hovered:
            if key == 'left mouse down':
                    ...
                    if health9 < 1:
                                ...
                                health -= damage8    
def chest(self):
        self.name = random.choice(["hp1","ap1","hap1"])
        if self.name == hp1:
